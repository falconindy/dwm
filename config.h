...
/* commands */
static const char *dmenucmd[]      = { "dmenu_launch", NULL };
...
/* audio */
static const char *volup[]         = { "ossvol", "-i", "1", NULL };
static const char *voldown[]       = { "ossvol", "-d", "1", NULL };
static const char *voltoggle[]     = { "ossvol", "-t", NULL };
